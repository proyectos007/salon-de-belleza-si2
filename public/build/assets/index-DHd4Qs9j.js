...
`)},h={root:function(n){var t=n.instance,e=n.props;return["p-inputtext p-component",{"p-filled":t.$filled,"p-inputtext-sm p-inputfield-sm":e.size==="small","p-inputtext-lg p-inputfield-lg":e.size==="large","p-invalid":t.$invalid,"p-variant-filled":t.$variant==="filled","p-inputtext-fluid":t.$fluid}]}},v=d.extend({name:"inputtext",theme:m,classes:h}),$={name:"BaseInputText",extends:f,style:v,provide:function(){return{$pcInputText:this,$parentInstance:this}}},x={name:"InputText",extends:$,inheritAttrs:!1,methods:{onInput:function(n){this.writeValue(n.target.value,n)}},computed:{attrs:function(){return a(this.ptmi("root",{context:{filled:this.$filled,disabled:this.disabled}}),this.formField)}}},g=["value","disabled","aria-invalid"];function b(i,n,t,e,o,l){return c(),u("input",a({type:"text",class:i.cx("root"),value:i.d_value,disabled:i.disabled,"aria-invalid":i.$invalid||void 0,onInput:n[0]||(n[0]=function(){return l.onInput&&l.onInput.apply(l,arguments)})},l.attrs),null,16,g)}x.render=b;export{f as a,x as s};
